...
def include_lidar_launch(context, *args, **kwargs):
    ...
    if lidar_type.startswith('ls'):            # LS 系列
        ...
        if lidar_type == 'lscx':
            ...
            #RT bijgevoegd volgende regel x10_cfg['use_time_service'] = True
            #x10_cfg['use_time_service'] = True
             #RT bijgevoegd volgende regel stamp_type (lidar dwingen om huidige tijd te gebruiken)
            #x10_cfg['stamp_type'] = 1 terug afgezet, we gebruiken systeemtijd
